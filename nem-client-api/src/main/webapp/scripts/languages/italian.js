	...
	texts: {
        ...
        common: {
        	...
        	appStatus: {
        		...
        		notBooted: "NIS richiede di essere avviato. Apri il tuo portafoglio ed avvia il nodo locale tramite la finestra di dialogo oppure configura l'auto-avvio.",
        		booting: 'Avvio di NIS in corso...',
        		nisInfoNotAvailable: 'Verifica dello stato di NIS...',
        		synchronizing: 'Sincronizzazione di NIS in corso. Al blocco {{1}}, {{2}} indietro.',
        		daysBehind: {
        			0: 'meno di un giorno',
        			1: 'un giorno',
        			many: '{{1}} giorni'
